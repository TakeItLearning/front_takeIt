    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          <p className="text-2xl">Cours uniques et aide</p>
          <h1 className="py-3 text-5xl md:text-7xl font-bold">
            Support numérique
          </h1>
          <p className="text-2xl">Ceci est notre marque de technologie.</p>
          <button className="py-3 px-6 sm:w-[60%] my-4">Commencer</button>
        </div>
        <div>
